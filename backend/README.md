...
## Project Structure
    ...
    ├── twilight_violet_dev_57818  # Django project configurations
...
1. Clone this repo and `cd twilight_violet_dev_57818`
...
2. Clone this repo and `cd twilight_violet_dev_57818`
